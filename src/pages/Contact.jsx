...
export default function Contact(){
    return(
      ...
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 w-full max-w-5xl">
        <h2 className="text-4xl font-bold text-white text-center mb-10">Get in Touch with <span className="text-red-400">Cartzy</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-white space-y-6">
            ...
            <div>
              <p><strong>📍 Address:</strong> 789 Future Drive, Tech District, NY 10001</p>
              <p><strong>📧 Email:</strong> support@Cartzy.com</p>
