                        ...
                        return <div key={index} className='bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] -z-10'>
                            <div className='flex flex-col md:flex-row gap-10 justify-center h-[600px] my-20 md:my-0 items-center px-4'>
                                <div className='md:space-y-6 space-y-3'>
                                    ...
                                    <h1 className='md:text-4xl text-xl font-bold uppercase line-clamp-1 md:line-clamp-3 md:w-[500px] text-white'>{item.title}</h1>
                                ...
                                <div>
                                    <img src={item.thumbnail || item.images} alt={item.title} className='object-contain bg-white rounded-full w-[550px] hover:scale-105 transition-all shadow-2xl shadow-red-400'/>
                                </div>
                            </div>
                        </div>
                    })
